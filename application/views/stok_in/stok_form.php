									...
									<form action="<?php echo $action; ?>" method="post">
										<thead>
											<table id="data-table-default" class="table  table-bordered table-hover table-td-valign-middle">
												...
												<tr>
													<td>Supplier<?php echo form_error('supplier_id') ?></td>
													<td>
														<select name="supplier_id" class="form-control theSelect">
															<option value="">-- Pilih -- </option>
												...
												<tr>
													...
													<td><input type="hidden" name="stok_id" value="<?php echo $stok_id; ?>" />
														...
														<a href="<?php echo site_url('stok_in') ?>" class="btn btn-grd-info"><i class="fa fa-undo"></i> Kembali</a>
													</td>
												</tr>
										</thead>
										</table>
