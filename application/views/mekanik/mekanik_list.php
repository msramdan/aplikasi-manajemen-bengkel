...
<div class="pcoded-inner-content">
	<div class="main-body">
        ...
        <?php echo anchor(site_url('mekanik/create'), '<i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-grd-info btn sm"'); ?></div><table id="simpletable" class="table table-bordered table-hover nowrap">
         <thead>
		...
		<th>Action</th>
			...
			<td>
				<?php 
				echo anchor(site_url('mekanik/read/'.encrypt_url($mekanik->mekanik_id)),'<i class="fa fa-eye" aria-hidden="true"></i>','class="btn btn-grd-success btn-sm read_data"'); 
				echo '  '; 
